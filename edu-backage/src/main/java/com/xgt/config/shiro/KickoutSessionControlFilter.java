...
public class KickoutSessionControlFilter extends AccessControlFilter {
    ...
    protected boolean onAccessDenied(ServletRequest request, ServletResponse response) throws Exception {
        ...
        BuildLabourer labourer = (BuildLabourer) subject.getPrincipal();
        String username = labourer.getPhone();
        ...
        logger.info("...username:{}.....deque.size:{}.......",username,deque.size());
        Iterator<Serializable> it =  deque.iterator();

        while (it.hasNext()){
            logger.info("........dequeIt:{}.......", String.valueOf(it.next()));
        }
