...
import com.xgt.controller.NoticeController;
...
public class VideoEncodeUtil {
    private static final Logger logger = LoggerFactory.getLogger(VideoEncodeUtil.class);

    public static void main(String[] args) throws Exception {
        encrypt("D:\\py交易\\11.mp4","fuckyourself");
        decrypt("D:\\py交易\\11.mp4","D:\\py交易\\22.mp4",4);
        System.out.println(readFileLastByte("D:\\py交易\\22.mp4",12));
    }
    /**
     * 文件file进行加密
     * @param fileUrl 文件路径
    ...
    public static String decrypt(String fileUrl, String tempUrl, int keyLength) throws Exception{
        ...
        FileToolUtil.createNewFile(tempUrl);
        //获取待解密的文件输入流
