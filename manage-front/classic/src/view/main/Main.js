Ext.define('Admin.view.main.Main', {
    ...
    initComponent: function () {
        ...
        Common.util.Util.doAjax({
            ...
            Common.Config.imageAddressUrl=record.imageAddressUrl;
        });

        //construct navigationTree store data
        if (record.menuList.length > 0) {
            record.menuList.splice(0, 0, {
                text: '首页',
        ...
        me.items = [{
            ...
            items: [{
                ...
                cls: 'sencha-logo',
                html: '<div class="main-logo" style="'+Common.Config.business_css+'"><img src="resources/images/logo.png" style="'+Common.Config.business_image_css+'">' + Common.Config.business_name + '</div>',
                width: 250
            }, {
                margin: '0 0 0 8',
                ui: 'header',
        ...
        if (!Ext.isChrome){
            Ext.Msg.alert("提示","推荐您使用谷歌浏览器获得更好的体验！");
        }
        //第一次登录需要修改密码
        if(modifyPassword==0) {
